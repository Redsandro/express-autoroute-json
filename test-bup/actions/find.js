...
const fixture = require('../fixtures/loadData')

const authorisationFunction = require('../../lib/authorisation')
const queryFunction = require('../../lib/query')
...
describe('the find block', function() {
	...
	it('should return a sorted array of objects', function(done) {
		...
		request(global.app).get('/chats?sortup=true').expect(200).expect(function(res) {
			const expected = _.sortBy(res.body.data, function(item) {
