...
module.exports = (options) => async(req, res, next) => {
	...
	try {
		...
		results = middlefy(options, 'beforeSerializer', 'find', results)
		results = serializer(req, results, relInclude, meta, options)
		results = middlefy(options, 'afterSerializer', 'find', results)
